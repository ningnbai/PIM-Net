...
if __name__ == "__main__":
    gt_folder_path = "./data/Columbia/mask"  # Replace with the path to the folder containing GT images
    pred_folder_path = "./results/ablation_no_prune/Columbia"  # Replace with the path to the folder containing pred images
